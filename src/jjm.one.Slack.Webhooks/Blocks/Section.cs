...
/// <summary>
///     A <see cref="Section" /> is one of the most flexible blocks available - it can be used as a
///     simple text block,
...
public class Section : Block
{
    ...
    /// <summary>
    ///     The <see cref="Text" /> for the block, in the form of a <see cref="TextObject" />. Maximum
