...
public class Section : Block
{
    ...
    /// <summary>
    ///     The <see cref="Text" /> for the block, in the form of a <see cref="TextObject" />. Maximum length for the text in
    ///     this field is 3000 characters.
    /// </summary>
    public TextObject Text { get; set; }

    /// <summary>
    ///     An array of <see cref="TextObject" />s. Any text objects included with <see cref="Fields" /> will be rendered in a
    ///     compact
