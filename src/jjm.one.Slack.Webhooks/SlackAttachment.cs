...
public class SlackAttachment
{
    ...
    /// <summary>
    ///     The provided string will act as a unique identifier for the collection of buttons within the
    ///     attachment. It will be sent back to your message button action URL with each invoked action.
    ...
    ///     characters, and may be truncated further when displayed to users in environments with limited screen real estate.
    /// </summary>
    public string? Footer { get; set; }

    /// <summary>
    ///     To render a small icon beside your footer text, provide a publicly accessible URL string in the
    ///     footer_icon field.
    ...
    ///     Use ts when referencing articles or happenings. Your message will have its own timestamp when
    ///     published.
    ...
    public bool ShouldSerializeTimestamp() => Timestamp.HasValue && Timestamp != 0;
}
