...
public enum SlackActionDataSource
{
    ...
    [EnumMember(Value = "conversations")] Conversations,
...
{
    [EnumMember(Value = "divider")] Divider = 1,
    [EnumMember(Value = "image")] Image = 2,
    [EnumMember(Value = "text")] Text = 3,
    [EnumMember(Value = "section")] Section = 4,
    [EnumMember(Value = "context")] Context = 5,
    [EnumMember(Value = "file")] File = 6,
    [EnumMember(Value = "actions")] Actions = 7,
    [EnumMember(Value = "input")] Input = 8,
    [EnumMember(Value = "header")] Header = 9
}
...
{
    Unknown = 0,
    [EnumMember(Value = "button")] Button = 1,
    [EnumMember(Value = "datepicker")] DatePicker = 2,
    ...
    [EnumMember(Value = "overflow")] Overflow = 9,

    [EnumMember(Value = "plain_text_input")]
    PlainTextInput = 10,
    [EnumMember(Value = "radio_buttons")] RadioButtons = 11,
    [EnumMember(Value = "static_select")] SelectStatic = 12,

    [EnumMember(Value = "external_select")]
    SelectExternal = 13,
    [EnumMember(Value = "users_select")] SelectUsers = 14,
