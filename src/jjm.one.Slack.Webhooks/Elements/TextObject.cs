...
public class TextObject : IContextElement
{
    ...
    /// </summary>
    public TextObject(string text) => Text = text;
    ...
    public bool ShouldSerializeEmoji() => Type == TextType.PlainText;

    public bool ShouldSerializeVerbatim() => Type == TextType.Markdown;
}
