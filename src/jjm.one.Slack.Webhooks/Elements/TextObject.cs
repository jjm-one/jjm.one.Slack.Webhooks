...
/// <summary>
///     An object containing some text, formatted either as <see cref="TextType.PlainText" /> or using
...
public class TextObject : IContextElement
{
    ...
    {
        [EnumMember(Value = "plain_text")] PlainText,

        [EnumMember(Value = "mrkdwn")] Markdown
    }
    ...
    /// <summary>
    ///     The text for the block. This field accepts any of the standard text formatting markup when type is
    ///     <see cref="TextType.Markdown" />.
    ...
    /// <summary>
    ///     Indicates whether emojis in a text field should be escaped into the colon emoji format. This field is only usable
    ///     when type is <see cref="TextType.PlainText" />.
    /// </summary>
    ...
    ///     Using a value of true will skip any preprocessing of this nature, although you can still include manual parsing
    ///     strings. This field is only usable when type is <see cref="TextType.Markdown" />.
