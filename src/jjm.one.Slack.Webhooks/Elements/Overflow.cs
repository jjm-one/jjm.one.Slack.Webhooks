...
///     visually important actions after a row of buttons. You can also specify simple URL links as overflow menu options,
///     instead of actions.
...
public class Overflow : Element, IActionElement
{
    ...
    /// <summary>
    ///     A <see cref="Confirmation" /> object that defines an optional confirmation dialog that appears after a menu item is
    ///     selected.
    /// </summary>
