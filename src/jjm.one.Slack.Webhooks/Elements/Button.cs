...
///     To use interactive components, you will need to make some changes to prepare your app. Read our guide to enabling
///     interactivity.
/// </summary>
public class Button : Element, IActionElement
{
    ...
    ///     <see cref="TextObject.TextType.PlainText" />. Maximum length for the text in this field is 75 characters.
    /// </summary>
