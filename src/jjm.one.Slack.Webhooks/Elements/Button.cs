...
///     An interactive component that inserts a button. The button can be a trigger for anything from
///     opening a simple link
///     to starting a complex workflow.
///     To use interactive components, you will need to make some changes to prepare your app. Read our
///     guide to enabling
///     interactivity.
/// </summary>
public class Button : Element, IActionElement
{
    ...
    /// <summary>
    ///     A <see cref="TextObject" /> that defines the button's text. Can only be of type:
    ...
    ///     to identify the source of the action. Should be unique among all other action_ids used
