...
///     A plain-text input, similar to the HTML &lt;input&gt; tag, creates a field where a user can enter freeform data. It
///     can appear as a single-line field or a larger textarea using the <see cref="MultiLine" />> flag.
///     Plain-text input elements are currently only available in modals. To use them, you will need to make some changes
