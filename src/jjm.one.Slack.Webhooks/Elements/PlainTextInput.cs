...
///     enter freeform data. It
///     can appear as a single-line field or a larger textarea using the <see cref="MultiLine" /> flag.
///     Plain-text input elements are currently only available in modals. To use them, you will need to
///     make some changes
///     to prepare your app. Read about preparing your app for modals.
...
public class PlainTextInput : Element, IInputElement
{
    ...
    /// <summary>
    ///     Indicates whether the input will be a single line (false) or a larger textarea (true). Defaults
    ///     to false.
    /// </summary>
    public bool MultiLine { get; set; }

    /// <summary>
    ///     The minimum length of input that the user must provide. If the user provides less, they will
    ///     receive an error.
    ...
    /// <summary>
    ///     The maximum length of input that the user can provide. If the user provides more, they will
    ///     receive an error.
    /// </summary>
